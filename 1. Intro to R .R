...
statement_together <- cat("What", "is", "up", "?") # use sep= "" to get rid of the spaces
...
# vs 
truth_the_letter <- "T"
class(truth_the_letter) 
# demonstrate autofill) # and how to get out of an unfisnished command
